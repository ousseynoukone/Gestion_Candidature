            ...
            <div class="col-md-12">
                <form method="post" id="form0" action="{{route('referentiels.store')}}">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text"  name="libelle" required pattern="^[a-zA-ZÀ-ÖØ-öø-ÿ'0-9\s.]+$"                     class="form-control">
                  </div>
...
<div class="row">
            ...
            <div class="col-md-12 mt-3 ">
                ...
                <form method="post" id="form1" >
                  ...
                  <div class="form-group" >
                    <label for="exampleInputEmail1">Libelle</label>
                    <input type="text" readonly id="libelle" name="libelle" required pattern="^[a-zA-ZÀ-ÖØ-öø-ÿ'0-9\s.]+$"  title="Le libelle ne peut contenir que des  lettres et espaces" class="form-control">
                  </div>
