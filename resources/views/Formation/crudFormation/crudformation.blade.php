            ...
            <div class="col-md-12">
                <form method="post" id="form0" action="{{route('formations.store')}}">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text"  name="nom" required pattern="^[a-zA-ZÀ-ÖØ-öø-ÿ'0-9\s.]+$"  class="form-control">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text"  name="description" required pattern="^[a-zA-ZÀ-ÖØ-öø-ÿ'0-9\s.]+$"  class="form-control">
                  </div>
...
<div class="row">
            ...
            <div class="col-md-12 mt-3 ">
                ...
                <form method="post" id="form1" >
                  ...
                  <div class="form-group" >
                    <label for="exampleInputEmail1">Nom</label>
                    <input type="text"   id="nom" name="nom" required pattern="^[a-zA-ZÀ-ÖØ-öø-ÿ'0-9\s.]+$"   class="form-control control">
                  </div>
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1"> Description </label>
                    <input type="text"  id="description" name="description" required pattern="^[a-zA-ZÀ-ÖØ-öø-ÿ'0-9\s.]+$"  class="form-control control">
                  </div>
