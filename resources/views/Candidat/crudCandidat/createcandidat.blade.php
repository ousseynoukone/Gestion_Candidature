...
<form method="post" action="{{route('candidats.store')}}">
  ...
  <div class="form-group">
    ...
    <input type="text"  name="nom" required pattern="^[a-zA-ZÀ-ÖØ-öø-ÿ]+[a-zA-Z0-9\sÀ-ÖØ-öø-ÿ]*$" title="Le nom ne peut contenir que des  lettres et espaces" class="form-control">
  </div>

  <div class="form-group">
    <label for="exampleInputEmail1">Prenom</label>
    <input type="text"  name="prenom" required pattern="^[a-zA-ZÀ-ÖØ-öø-ÿ]+[a-zA-Z0-9\sÀ-ÖØ-öø-ÿ]*$" title="Le nom ne peut contenir que des lettres et espaces" class="form-control">
  </div>
  ...
  <div class="form-group">
    ...
    <input type="number"  name="age" min="5" max="35" required pattern="^[0-9]+$" title="Que les chiffres sont acceptés" class="form-control">
  </div>
